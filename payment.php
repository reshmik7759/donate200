...
<head>
	...
	<script type="text/javascript">
	 function show(val){
	    var element1=document.getElementById('payment');
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item"><a href="about.html" class="nav-link">Add Yor Partner</a></li>
					<li class="nav-item"><a href="javascript:show('pay')"  value="pay" class="nav-link">Payment</a></li>
					<li class="nav-item cta"><a href="contact.html" class="nav-link">Status</a></li>
					<li class="nav-item cta"><a href="Login.php" class="nav-link">Logout</a></li>
				</ul>
			</div>
		</div>
	</nav>	
